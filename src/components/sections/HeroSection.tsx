...
export const HeroSection = () => {
  return (
    <section className="h-[calc(100vh-76px)] bg-dark overflow-hidden flex flex-col relative">
      {/* Desktop Layout */}
      <div className="hidden sm:flex flex-1 flex-col px-3 sm:px-4 lg:px-5 pb-3 sm:pb-4 lg:pb-5 gap-3 sm:gap-4 lg:gap-5">
        {/* Video Container */}
      ...
      <div className="flex sm:hidden flex-1 flex-col px-3 pb-3 gap-3">
